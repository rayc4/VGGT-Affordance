...
class SimpleMaskRefinementTrainLoop:
    ...
    def __init__(self, *, cfg, model, dataloader, val_dataloader=None, **kwargs) -> None:
        ...
        self.bce_loss_weight = float(cfg.get('bce_loss_weight', 0.15))
        self.dice_loss_weight = float(cfg.get('dice_loss_weight', 0.35))
        self.focal_loss_weight = float(cfg.get('focal_loss_weight', 0.15))
        self.iou_loss_weight = float(cfg.get('iou_loss_weight', 0.35))
